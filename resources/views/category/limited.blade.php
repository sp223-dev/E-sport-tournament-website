...
@section('content')
@section('title', 'E-sport | Limited Collection')


<div class="store-banner position-relative banner-hidden" style="height: 350px;
background: url(../images/store/LIMITED-COLLECTION.webp) 70% 70% / cover no-repeat !important;">
                    ...
                    <div class="row">
                        <div>
                            @foreach ($products as $product )
                                @if ($product->category->name == 'Limited')

                                    <div class="col-md-4 col-sm-6">
                                        <div class="store-list-item">
                                            <div>
                                                <a href="{{ url ('store/product') }}/{{ $product->id }}">
                                                    <span class="store-badge hot">{{ $product->category->name }}</span>
