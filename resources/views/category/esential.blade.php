...
@section('content')
@section('title', 'E-sport | Essential Collection')


<div class="store-banner position-relative banner-hidden" style="height: 350px;
background: url(../images/store/ESSENTIALS-COLLECTION.webp) 70% 70% / cover no-repeat !important;">
