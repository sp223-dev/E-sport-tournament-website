...
@section('content')
@section('title', 'E-sport | Performance Collection')


<div class="store-banner position-relative banner-hidden" style="height: 350px;
background: url(../images/store/PERFORMANCE-COLLECTION.webp) 70% 70% / cover no-repeat !important;">
                    ...
                    <div class="row">
                        <div>
                            @foreach ($products as $product )
                                @if ($product->category->name == 'Performance')
