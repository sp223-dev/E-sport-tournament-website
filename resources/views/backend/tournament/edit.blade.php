...
<div id="app">
  <div class="container mt-4">
    ...
    <h1 class="font-weight-bolder text-center">EDIT TOURNAMENT</h1>

    <div class="row ">
      <div class="col-lg-2"></div>
      <div class="col-8">
      <form class="bg-white border p-5 " method="POST"  action="{{route('tournament-update', ['id' => $tournament -> id])}}" enctype="multipart/form-data">
        {{ csrf_field() }}
