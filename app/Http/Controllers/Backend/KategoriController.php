...
class KategoriController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // dd($itemkategori);
        return view('backend.store.kategori.index', compact('itemkategori'))->with('no', ($request->input('page', 1) - 1) * 20);
    ...
    {
        // $itemkategori = Kategori::all();
        return view('backend.store.kategori.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kategori-home', compact('itemkategori'))->with('success', 'Data kategori berhasil disimpan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.store.kategori.edit', ['itemkategori'=>$itemkategori]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validasislug) {
            ...
            return redirect()->route('kategori-home')->with('success', 'Data berhasil diupdate');
    }
}
