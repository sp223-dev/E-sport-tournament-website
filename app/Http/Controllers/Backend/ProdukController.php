...
class ProdukController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('backend.store.produk.index', compact('itemproduk'))->with('no',($request->input('page', 1) - 1) * 5);
    }
    ...
    public function create()
    {
        ...
        return view('backend.store.produk.create', compact('itemkategori'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('produk-home', compact('itemproduk'))->with('success', 'Data berhasil disimpan');
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.store.produk.show', compact('itemproduk'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.store.produk.edit',compact('itemproduk', 'itemkategori'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validasislug) {
            ...
            return redirect()->route('produk-home')->with('success', 'Data berhasil diupdate');
        }
    }
